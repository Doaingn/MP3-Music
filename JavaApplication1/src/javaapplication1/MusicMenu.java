...
public class MusicMenu extends javax.swing.JFrame {
    ...
    // Constructor where you can initialize components and start the timer
    public MusicMenu() {
        ...
        MusicArtist.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
    ...
    public void updateMusicInfo() {
        if (player.getCurrentMusic() != null) {
            MusicTitle.setText(player.getCurrentMusic().getMusicTitle());
            MusicArtist.setText(player.getCurrentMusic().getMusicArtist());
    ...
    public void updateMusicArt(){
        byte[] albumArt = player.getCurrentMusic().getMusicAlbumArt();
            if (albumArt != null) {
    ...
    private void initComponents() {
        ...
        PlayPause.getAccessibleContext().setAccessibleName("PlayPausebtn");
        ...
        MusicArtist.setFont(new java.awt.Font("Prompt", 0, 14)); // NOI18N
        MusicArtist.setForeground(new java.awt.Color(204, 204, 204));
        MusicArtist.setText("--------------------------------------------------------------------------------------");
        MusicArtist.setFocusable(false);
        MusicArtist.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        getContentPane().add(MusicArtist, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 530, 520, 30));

        MusicTitle.setFont(new java.awt.Font("Prompt", 0, 24)); // NOI18N
        MusicTitle.setForeground(new java.awt.Color(255, 255, 255));
        MusicTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        MusicTitle.setText("---------------------------------------------------");
        getContentPane().add(MusicTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 490, 520, 50));

        PlayerStatus.setFont(new java.awt.Font("Prompt", 0, 20)); // NOI18N
        PlayerStatus.setForeground(new java.awt.Color(255, 255, 255));
        PlayerStatus.setText("ไม่มีเพลงที่กำลังเล่นอยู่");
        PlayerStatus.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        getContentPane().add(PlayerStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 10, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MusicMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel MusicArtist;
